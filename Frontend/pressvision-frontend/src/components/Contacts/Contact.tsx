                    ...
                    <div className="row g-4">
                        <div className="col-lg-5">
                            <div className="">
                                ...
                                <h4 className="lh-base mb-4">Receive messages instantly with our PHP and Ajax contact form - available in the <a href="https://htmlcodex.com/downloading/?item=3179">Pro Version</a> only.</h4>
